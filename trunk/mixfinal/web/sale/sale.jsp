...
<div >
    <form id="buyrice" name="buyrice" >
        <table>
            <tr>
                <td><label for="name">ส่วนการขายออก</label></td>
                <td></td>
            </tr>
            <tr>         
        ...
        <table>
            ...
            <tr>
                ...
                <td  ><label>
                        <input name="radiobut" type="radio" value="กข.6" onclick="selectRiceType(0)" />
                    </label>
                    กข.6 
                    <input name="radiobut" type="radio" value="กข.15" onclick="selectRiceType(1)"/>
                    กข.15
                    <input name="radiobut" type="radio" value="1"  onclick="selectRiceType(2)"/>
                    <label></label>
                    ชนิดอื่น ๆ <label>
                    <input name="textfield42" type="text" onkeyup="setTimeout('complet()',2000);" size="15" /></label>
                </td>
                    <td  id="val1"><div id="val_1"></div>
                </td>
            </tr>
    ...
    <form id="caculateform" name="caculateform" >
        <table>
            ...
            <tr>
                ...
                <input type="button" name="Submit3" value="  บันทึก   " onclick="sentBuy('form1')" />
